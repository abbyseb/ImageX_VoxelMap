# Voxelmap Tutorial - Patient P2 (SPARE Dataset)
...
### [1. Imports](tutorialspare_final_P2.ipynb#L1)
...
### [2. File Names Configuration](tutorialspare_final_P2.ipynb#L14)

Sets up data paths and experiment naming conventions.

**Configuration:**
- `Patient_number = "P2"`: Patient identifier
...
**Generated paths:**
- Input: `/srv/shared/SPARE/MC_V_P2_NS_01`
- Weights: `SPARE_A_P2_weights/`
- Plots: `SPARE_A_P2_plots/`

### [3. Dataset Setup](tutorialspare_final_P2.ipynb#L36)
...
### [4. Data Visualization](tutorialspare_final_P2.ipynb#L94)
...
### [5. Projection Similarity Check](tutorialspare_final_P2.ipynb#L122)

Computes cosine similarity between no-scatter and scatter projections to quantify anatomical/scatter differences.


### [6. Training Loop](tutorialspare_final_P2.ipynb#L171)
...
**Saved outputs:**
- `SPARE_A_P2_ckpt.pth`: Resume checkpoint (full state)
- `SPARE_A_P2_best.pth`: Best validation weights (inference)
- `SPARE_A_P2_TRAINvsVAL.png`: Loss curve visualization
...
### [7. Testing File Configuration](tutorialspare_final_P2.ipynb#L246)
...
### [8. Target ITV/PTV Generation](tutorialspare_final_P2.ipynb#L269)
...
**Output:** `Target_ITVs_ALL_SPARE_A_P2/Target_XXXXX_ITV_PTV.npy` (680 files)

**Why needed:** Provides ground-truth for Dice score and centroid tracking evaluation.

### [9. Testing Dataset Class](tutorialspare_final_P2.ipynb#L350)
...
### [10. Model Loading](tutorialspare_final_P2.ipynb#L431)

Loads trained Network A weights for inference.

**Configuration:**
- Device: `cuda:1`
- Weights: `SPARE_A_P2_weights/SPARE_A_P2_best.pth`
- Mode: `eval()` (disables dropout/batch norm training behavior)

### [11. Testing Loop](tutorialspare_final_P2.ipynb#L449)
...
### [12. Results Saving and Visualization](tutorialspare_final_P2.ipynb#L525)
...
Located in: `/srv/shared/SPARE/MC_V_P2_NS_01/`
...
#### Training Outputs
Located in: `SPARE_A_P2_weights/` and `SPARE_A_P2_plots/`

| File | Description | Size |
|------|-------------|------|
| `SPARE_A_P2_ckpt.pth` | Full checkpoint (resumable) | ~200 MB |
| `SPARE_A_P2_best.pth` | Best validation weights | ~100 MB |
| `SPARE_A_P2_TRAINvsVAL.png` | Loss curve plot | ~50 KB |

#### Testing Outputs
Located in: `SPARE_A_P2_plots/SPARE_A_P2_Experiment/`
...
| `SPARE_A_P2_trace.png` | Motion tracking plot | Image |

#### Intermediate Files
Located in: `Target_ITV_SPARE_A_P2/` and `Target_ITVs_ALL_SPARE_A_P2/`
